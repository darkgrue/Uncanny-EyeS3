...
String Arduino_SY6970::IIC_Read_Device_State(uint32_t information)
{
  ...
  case Arduino_IIC_Power::Status_Information::POWER_NTC_FAULT_STATUS:
    ...
    return "->Read SY6970_RD_DEVICE_0C fail";
    break;
  case Arduino_IIC_Power::Status_Information::POWER_BATFET_STATUS:
    if (_bus->IIC_ReadC8D8(_device_address, SY6970_RD_WR_DEVICE_09, &temp_buf) == true)
    {
      temp_buf &= 0B00100000;
      ...
      {
      case 0B00000000:
        return "BATFET Enabled";
        break;
      case 0B00100000:
        return "BATFET Disabled";
        break;

      default:
        return "->Read POWER_BATFET_STATUS fail";
        break;
      }
    }

    return "->Read SY6970_RD_WR_DEVICE_09 fail";
    break;
